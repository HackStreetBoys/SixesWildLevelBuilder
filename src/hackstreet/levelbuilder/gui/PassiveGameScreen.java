...
public class PassiveGameScreen extends AbstractScreen {
	...
	public PassiveGameScreen(LevelBuilderApplication application, int level) {
		...
		this.backButton.addActionListener(new ToEditLevelController(super.getApplication()));
